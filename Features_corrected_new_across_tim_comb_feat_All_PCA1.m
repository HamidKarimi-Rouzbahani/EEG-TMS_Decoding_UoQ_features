    ...
    for Feat_selection=[13:19]
        for Subject=1:2
            ...
            for condition=1:length(conditions)
                ...
                for trial=1:size(EEG.data,3)
                    for channel=1:size(EEG.data,1)
                        signal(channel,1:length(time_window),condition,trial)=EEG.data(channel,801:2000,trial);
                    end
                end
            end
            ...
            for windoww=Windows
                ...
                %% Classification
                clearvars -except time_window conditions Subjects Feat_selection Sel_feat Windows Subjects bands lowband highband band windows windoww wind Dataset Fs True_Predicted_labels accuracy Subject signal feature X Y  net
                ...
                for combination=1:size(combinations,1)
                    ...
                    rmpath(genpath('C:/Users/mq20185770/Documents/MATLAB/Claire/FSLib_v6.2.1_2018'))
                    ...
                    addpath(genpath('C:/Users/mq20185770/Documents/MATLAB/Claire/FSLib_v6.2.1_2018'))
            ...
            save(['Corrected_Dec_DS_Claire_Att_Band_',Bands{band},'_Wind_sliding_Subject_',num2str(Subject),'_CombFeat_',selection_method,'_PCA.mat'],'accuracy','Sel_feat');
        end
    end
end
