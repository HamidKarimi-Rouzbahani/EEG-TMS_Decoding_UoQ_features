        ...
        for condition=1:length(main_conditions)
            ...
            for the_other_condition=0:1
                if decoding==1
                    ...
                    EEG=pop_loadset('filename',['sub-',Subjects{Subject},'_GA_crit_',main_conditions{condition},'_',the_other_cond,'.set'],'filepath','D:\\Hamid\\Claire\\Data\\');
                elseif decoding==2
                    if the_other_condition==0
                    ...
                    EEG=pop_loadset('filename',['sub-',Subjects{Subject},'_GA_crit_',the_other_cond,'_',main_conditions{condition},'.set'],'filepath','D:\\Hamid\\Claire\\Data\\');
                end
